...
**Expected GUI:** +
Displays google map of Alex Chew
...
**Command:** +
* clear
* import data/[F10-B4][MyBook]SampleData2.xml

**Expected :** +
Addressbook successfully imported from: data/[F10-B4][MyBook]SampleData2.xml

**Expected GUI:** +
* Added a new person called Choony.
* Updated `Bernice Yu` remark section.
